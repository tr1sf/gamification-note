  ...
  return (
    <main class="min-h-screen flex items-center justify-center bg-surface relative overflow-hidden p-4">
      ...
      <div class="relative z-10 w-full max-w-md">
        ...
        <div class="p-8 rounded-xl border border-surface-border bg-surface-elevated" style="box-shadow: 0 1px 3px rgb(0 0 0 / 0.06), 0 4px 20px rgb(0 0 0 / 0.04), inset 0 0 0 1px color-mix(in oklab, var(--color-accent) 5%, transparent);">
