  ...
  return (
    <main class="min-h-screen flex items-center justify-center bg-surface relative overflow-hidden px-4">
      ...
      <div class="relative z-10 w-full max-w-sm sm:max-w-md">
        ...
        <div class="absolute -top-1 -left-1 -right-1 -bottom-1 sm:-top-1.5 sm:-left-1.5 sm:-right-1.5 sm:-bottom-1.5 rounded-xl border border-accent/15 -z-10" style="box-shadow: inset 0 0 40px color-mix(in oklab, var(--color-accent) 4%, transparent);" />
