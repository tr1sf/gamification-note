...
export default function RegisterPage() {
  return (
    <main class="min-h-screen flex items-center justify-center bg-surface relative overflow-hidden p-4">
      <div class="absolute inset-0 opacity-[0.025] dark:opacity-[0.05]" style="background-image: radial-gradient(circle, rgb(var(--color-accent)) 1px, transparent 1px); background-size: 20px 20px;" aria-hidden="true" />
      ...
      <div class="relative z-10 w-full max-w-md">
        ...
        <div class="absolute -top-1.5 -left-1.5 -right-1.5 -bottom-1.5 rounded-xl border border-accent/15 -z-10" aria-hidden="true" style="box-shadow: inset 0 0 40px rgb(var(--color-accent) / 0.04);" />

        <div class="p-8 rounded-xl border border-surface-border bg-surface-elevated" style="box-shadow: 0 1px 3px rgb(0 0 0 / 0.06), 0 4px 20px rgb(0 0 0 / 0.04), inset 0 0 0 1px rgb(var(--color-accent) / 0.05);">
