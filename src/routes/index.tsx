...
export default function Home() {
  return (
    <main class="min-h-screen flex flex-col items-center justify-center bg-surface text-center p-8 relative overflow-hidden">
      <div class="absolute inset-0 opacity-[0.03] dark:opacity-[0.06]" style="background-image: radial-gradient(circle, var(--color-accent) 1px, transparent 1px); background-size: 24px 24px;" aria-hidden="true" />
