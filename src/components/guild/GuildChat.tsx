    ...
    <div class="flex flex-col h-[60vh] rounded-lg border border-surface-border bg-surface">
      ...
      >
        ...
        <button
          ...
          class="px-4 py-2 bg-accent text-white rounded-md text-sm font-medium hover:bg-accent-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
        >
          Send
        </button>
      </form>
