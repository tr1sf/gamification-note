...
// Daily reward budget (replaces diminishing returns tiers)
export const DAILY_XP_BASE_CAP = 150;
export const DAILY_XP_PER_LEVEL = 25;
export const DAILY_COIN_BASE_CAP = 30;
export const DAILY_COIN_PER_LEVEL = 5;
